...
public class Arius {
	...
	private String [] NomeApelos = {"Chifrada", "Compreenção", "Striptease", "Mostrar o unico mamilo rosa", "Diplomacia", "5 é 20", "Arma e escudo", "Gladio arcoiris"};
	private String [][] ConteudoDescricao = {  {"afeta o adversario acima de você.", " ", " ", " "},
											   {"compreende", " ", " ", " "},
											   {"esta na hora de tirar a sua armadura", " ", " ", " "},
											   {"o mamilo. afeta todos que estao acima de você.", " ", " ", " "},
											   ...
											   {"mostre sua masestria com essas armas", " ", " ", " "},
