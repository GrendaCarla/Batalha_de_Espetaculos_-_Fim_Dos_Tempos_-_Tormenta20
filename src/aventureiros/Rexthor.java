...
public class Rexthor {
	...
	private String [][] ConteudoDescricao = {  {"Um gancho bem dado no queixo", " ", " ", " "},
											   ...
											   {"Você não malha atoa, flexione seus músculos tonificados e ofusque os seus", "adversários", " ", " "},
											   ...
											   {"Sua tanga esconde várias coisas, muitas delas são dos seus amigos. Enfie", "a mão e retire algo que os surpreendam.", " ", " "}};	
