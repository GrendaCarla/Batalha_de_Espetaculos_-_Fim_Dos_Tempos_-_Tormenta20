...
public class Kiki {
	...
	private String [][] ConteudoDescricao = {  {"Como já é conveniente", "O ofício culinário salva o dia novamente.", "Ao ficarem sedentos com a refeição de alta qualidade,", "Nem imaginam o trabalho que dá para impedir os furtos de gorad.", " "},
			...
			private String [][] ConteudoEscolhaAdversario = {{"- Chegamos!", "- Como já deve conhecer das minhas inúmeras canções, esta é a famosa aldeia Orc onde os", "admiráveis cães das Colinas teve seu início em uma memorável batalha contra 500 de seus", "mais poderosos e profanos guerreiros canibais."},
															 ...
															 {"- Vamos, o cheiro da comida está delicioso!", "- Claro, não tanto quanto a minha, porque, como já deve ter ouvido falar, eu levo refeições muito", "a sério e sou extremamente talentosa com várias coisas incluindo culinária.", "- Um dia farei algo especial para você provar, eu prometo."},
			...
			// 6---------------------------- se a Kiki for a escolhida e teve o primeiro contato, mas não batalhou = |1|0|0|0|0| -------------------
															 {"- Shiiii! Fala mais baixo, a ressaca bateu forte e esse sol não está colaborando.", "- O quê? Ah, sim, eu vou ficar bem, já bebi muito para um contratempo simples como esse me", "parar.", "- Só me dê uns minutinhos, sim."},
			...
			// 31--------------------------- se a Kiki for a escolhida e perdeu na última luta, mas tem 1 vitória = |1|1|1|0|2| -------------------
															 {"- Me deixe aqui, eu não quero me apresentar novamente, a última derrota foi muito humilhante.", "- Do que você está falando? Você está tentando me animar?", "- Pois continue, se me contar alguma história sua talvez funcione, quem sabe.", " "},
			...
			// 45--------------------------- se a Kiki for a escolhida e 3º vitória na última luta = |1|3|0|0|1| -------------------
															 ...
															 {"- E para comemorar, esta noite nós não teremos ração de viagem coisa nenhuma. Nós vamos", "saborear um delicioso churrasco com tudo que tem direito feito por esta excelente mestre cuca.", "- Hoje é um dia para ser aproveitado, porque daremos adeus a Lala, Tanna-Toh e a esse lugar.", " "},
			// 47--------------------------- se a Kiki [[[NÃO]]] for a escolhida e primeira interação |0|0|0|0|0 ---------------------------------
															 ...
															 {"- Está vendo aquele ali de amarelo?", "- Ele é o Lala, assim, o nome real é Lena, mas temos que concordar que Lala combina muito", "mais com sua personalidade.", " "},
															 {"- Vamos, o cheiro da comida está delicioso!", "- Claro, não tanto quanto a minha, porque, como já devem ter ouvido falar, eu levo refeições", "muito a sério e sou extremamente talentosa com várias coisas incluindo culinária.", "- Eu prometo que um dia desses farei algo especial para vocês provarem."},
															 ...
															 {"- Olha, estou extremamente surpresa que vocês não queiram competir, poderia me dizer o", "porquê?", "- Verdade! Vocês têm toda razão, como não poderíamos passar a noite inteira bebendo e", "comemorando com nossos amigos que não via há tanto tempo, falha minha."},
			...
			// 71--------------------------- se a Kiki [[[NÃO]]] for a escolhida e 1º vitória na última luta = |1|1|0|0|1| -------------------
															 ...
															 {"- Como eu já falei antes, vocês formam uma dupla incrível e todos reconheceram os seus", "talentos inatos.", " ", " "},
															 {"- Principalmente aqueles bobões, feiosos, chatos que ficam querendo separar o grupo por", "motivos bestas.", "- Mas agora, que cada um levou uma surra, vão querer se unir novamente e todos vamos ficar", "felizes e contentes juntos vivendo grandes aventuras sem ser abandonada mais uma vez."},
															 {"*Sons de vômito*", "- Eu... acho que posso ter exagerado um pouquinho.", " ", " "},
			...
			// 84--------------------------- se a Kiki [[[NÃO]]] for a escolhida e 2º vitória na última luta  = |1|2|4|0|1| -------------------
															 {"- Me deixem em paz, eu não quero me apresentar novamente, a última derrota foi muito", "humilhante.", "- Do que está falando? Você está tentando me animar?", "- Pois continue, se me contar alguma história sua talvez funcione, quem sabe."},
			...
			// 93--------------------------- se a Kiki [[[NÃO]]] for a escolhida e 3º vitória na última luta = |1|3|0|0|1| -------------------
															 ...
															 {"- E para comemorar, esta noite vocês não terão ração de viagem coisa nenhuma. Nós vamos", "saborear um delicioso churrasco com tudo que tem direito feito por esta excelente mestre cuca.", "- Hoje é um dia para ser aproveitado, porque vocês darão adeus a Lala, Tanna-Toh e a mim.", " "},
