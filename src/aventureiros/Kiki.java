...
public class Kiki {
	...
	private String [][] ConteudoDescricao = {  {"Como é de se esperar, o oficio culinário salvando o dia novamente. De um Show digno do", "MasterChef e conquiste a plateia pela barriga.", " ", "PS: Não deixe o Arius roubar o gorad.", " "},
											   ...
											   {"Eu, enganando alguém, imagina. Tudo que estou tentando fazer é ajuda-lo a enxergar a", "verdade ambígua dessa situação em que se encontra, para poder gerar uma situação de", "proveito mutuo, no qual algumas partes ganham o beneficio material e as outras o espiritual.", "Eu estou lhe dando paz de espirito, de nada.", "Esta habilidade afeta o primeiro campo."},
											   {"Com sua espetacular e refinada técnica de propagar historias particulares você é capaz de", "retirar o primeiro colocado do seu pedestal causando uma alta interferência nele.", " ", " ", "Esta habilidade afeta o primeiro campo."},
											   {"Ao fixarem os olhares em você se torna difícil quebra-los. Use seu olhar penetrante nos", "adversários ao seu redor e faça-os ficarem atordoados.", " ", " ", "Esta habilidade afeta um campo acima e um abaixo."},
											   {"Então, você não é a melhor nesse quesito, mas o bom é que tem vários amigos que se", "jogariam na sua frente para protege-la.", " ", " ", "Esta habilidade afeta o campo acima de você."},
											   {"Desafie seus oponentes para uma competição de birita e os vença facilmente enquanto o", "vomito rola souto.", " ", " ", "Esta habilidade afeta todos os campos acima de você."},
											   {"Digamos que seu estilo de higiene é questionável, mas graças a isso você desenvolveu uma", "poderosa arma biológica, use-a a seu favor.", " ", " ", "Esta habilidade afeta todos os campos abaixo de você."}};	
