...
public class Ayla {
	...
	private String [][] ConteudoEscolhaAdversario = {{"- Bom-dia Srta. Ayla e companhia!", "- Os relatórios da produção de bom- batons e a nova versão dos contratos com as \"fontes de", "tamanhos variados\" já estão prontas e na sua mesa como solicitou.", " "},
													 ...
													 {"- Então, eu estava pensando, já que estamos aqui na magnífica cede do Empório Purpúrea, que", "tau realizarmos uma competição de apresentações?", " ", " "},
													 {"- Ah! Que bom que você concordou.", "- Quem sabe, se ganharmos essa partida eu torne você uma das prestigiosas consultoras", "Mary Fay.", "As apresentações SEM interferência ganharão -1 de apelo."},
	...
	// 5----------------------------- se a Ayla for a escolhida e teve o primeiro contato, mas não batalhou = |1|0|0|0|0| -------------------
													 {"- Essa poltrona é tão confortável, estava morrendo de vontade de descansar as minhas asinhas.", "- Falando em vontade, já que voltamos, você decidiu se quer competir agora?", " ", " "},
													 {"- Ah! Que bom que você concordou.", "- Quem sabe se ganharmos essa partida eu torne você uma das prestigiosas consultoras", "Mary Fay.", "As apresentações SEM interferência ganharão -1 de apelo."},
	...
	// 11---------------------------- se a Ayla for a escolhida e desistiu == 6 no meio da última luta = |1|0|0|6|3| -------------------
													 ...
													 {"- Vou falar sinceramente agora, então é melhor aproveitar porque essa oportunidade é rara.", "- Não teste minha paciência, posso ser pequena e adorável, mas se você me decepcionar mais", "uma vez... acabou.", "As apresentações SEM interferência ganharão -1 de apelo."},
													 {"- Certo.", " ", " ", " "},
	...
	// 28---------------------------- se a Ayla for a escolhida e 2º vitória na última luta  = |1|2|4|0|1| -------------------
													 ...
													 {"- Entretanto essa quantidade não é o suficiente.", "- Segundo a sub-seção 7 do meu plano de domin- expansão parte 1, o Empório Purpúrea", "precisa de mais 120% de aumento nas vendas.",  " "},
													 ...
													 {"- Certo, acredito que me exaltei um pouco hihihihi.", "- O dia está sendo cansativo, vamos falar de novo outra hora.", " ", " "},
	// 33---------------------------- se a Ayla for a escolhida e derrota na última luta com 2 vitórias = |1|2|1|0|2| -------------------
													 {"- Nossa, foi quase, faltou só um pouquinho assim. Talvez algo mais escandaloso da próxima", "vez, o que você acha?", "- QUE ISSO! Eu não esperava tanta malícia saindo de você. Olha, eu gostei.", " ", " "},
	...
	// 37---------------------------- se a Ayla for a escolhida e 3º vitória na última luta = |1|3|0|0|1| -------------------
													 {"- Eu ainda estou eufórica com a última luta, demos um show para todo mundo e agora todos,", "todos mesmos, estão ainda mais loucos pelos produtos Purpúrea.", "- Nossa parceria foi uma das melhores ideias que eu já tive e olha que eu tenho várias ideias", "geniais diariamente."},
	...
	// 49---------------------------- se a Ayla [[[NÃO]]] for a escolhida e desistiu == 6 no meio da última luta = |1|0|0|6|3| -------------------
													 ...
													 {"- Vou ser sincera agora, então é melhor aproveitarem porque essa oportunidade é rara.", "- Não testem minha paciência, posso ser pequena e adorável, mas se vocês me decepcionarem", "mais uma vez... acabou, sem luta e sem visita.", "As apresentações SEM interferência ganharão -1 de apelo."},
	...
	// 60---------------------------- se a Ayla [[[NÃO]]] for a escolhida e perdeu na última luta, mas tem 1 vitória = |1|1|1|0|2| -------------------
													 ...
													 {"- Espera, você está me dizendo que quer outra chance?", "- Nessa empresa damos 110%, nós tramam- trabalhamos enquanto os outros dormem, não", "existe barreiras físicas ou morais que não voamos por cima. Me mostrem do que são capazes!", "As apresentações SEM interferência ganharão -1 de apelo."},
	...
	// 67---------------------------- se a Ayla [[[NÃO]]] for a escolhida e derrota na última luta com 2 vitórias = |1|2|1|0|2| -------------------
													 {"- Dessa vez foi por quase, faltou só um pouquinho assim para ganharem. Talvez algo mais", "escandaloso da próxima vez.", "- Vamos? Eu tenho um público avido me esperando e o trabalho de uma vigar- artista não para.", "As apresentações SEM interferência ganharão -1 de apelo."},
													 {"- Mas em fim, aceitam um café, chá ou bolinhos?", "- Ou gostariam de conhecer o nosso relançamento de poções super concentradas? Agora com", "mais poder em um frasco menor, capaz de fazer goblin virar elfo e bárbaro virar bardo.", " "},
	// 69---------------------------- se a Ayla [[[NÃO]]] for a escolhida e 3º vitória na última luta = |1|3|0|0|1| -------------------
													 ...
													 {"- Eu ainda estou eufórica com a última luta, vocês deram um show para todo mundo e agora todos,", "todos mesmos, estão ainda mais loucos pelos produtos Purpúrea.", "- Nossa parceria foi uma das melhores ideias que eu já tive e olha que eu tenho várias ideias", "geniais diariamente."},
													 {"- Então, depois de toda essa agitação eu sugiro que foquem em enfrentar os outros cães das", "colinas. Como eu falei lá atrás você só se juntará oficialmente a mundialmente famosa Ayla", "Corporation quando derrotarem todos os cinco Cães das Colinas três vezes.", "- Boa sorte!"},
	// 72---------------------------- se vencer 3 vezes todos os cães das colinas -------------------
													 {"- Após enfrentar Ignis Crae o paladino de Thyatis, Rexthor o ex-gladiador mais sortudo que", "existe, Kiki a barda de puro talento, Arius o filósofo seguidor de Tanna-toh e Ayla a fada", "empreendedora mais honesta de Arton, você retorna até nós exibindo suas vitórias com orgulho.", "- E como prometido, você se tornará um de nós."},
													 {"- Agora vamos assinar o pac- contrato.", "- Não precisa ler tudo se não quiser, as letrinhas miúdas são apenas formalidade.", " ", " "},
													 {"- Agora oficialmente você faz parte da família Empório Purpúrea, meus parabéns!", " ", " ", " "}};
