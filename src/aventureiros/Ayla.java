...
public class Ayla {
	...
	private String [][] ConteudoDescricao = {  {"Conte mentiras e engane os mais fortes, use sua expertise para se sobressair", "dos demais. Este poder afetará o primeiro colocado.", " ", " "},
											   {"Cores, sons e brilhos, nada como usar sua magia feérica para maravilhar o", "público. É claro que isso não significa não poder atrapalhar um pouquinho os", "seus amigos. Este poder afetará todos acima de você.", " "},
											   {"Borboleta, urubu ou uma nobre senhora modificada pela tormenta, você pode ser o que ", "quiser com os produtos Mary Fay, traga mais possibilidades para sua vida.", " ", "                                                         - Empório Purpúrea."}, 
											   {"A fada mais honesta de Arton também é encantadora e adorável, use sua", "aparência purpurinadamente inofensiva para ganhar o afeto da plateia e ofuscar", "os demais concorrentes. Este poder afetará todos abaixo de você.",  " "},
											   {"Você manifesta e dispara uma adaga imaterial contra a mente do alvo.", "Este poder afetará O adversário acima de você.", " ", " "},
											   {"Fogo, calor e pirotecnia, incendeie o palco com o seu poder e inflame a", "torcida a seu favor. Este poder afetará todos acima de você.", " ", " "},
											   {"Faça cópias perfeitas de si mesma dificultando seus amigos a te atrapalharem.", "Este poder vai restaurar seus pontos de apelo para zero, use quando presumir", "que ficará com apelo negativo na rodada.", " "}, 
											   {"Depois de tanta agitação e diversão é sempre bom descansar, faça um favor", "a seus companheiros e de um momento de paz e tranquilidade no meio da", "batalha. Este poder afetará um campo acima e abaixo de você.", " "}};
	...
	private String [][] ConteudoEscolhaAdversario = {{"Minhas boas vindas a Ayla Corporation. Como posso ajudar?", "Gostaria de falar com a Srta. Ayla?", "Vejamos", "- Ayla Corporation, em breve rebranding"},
													 ...
													 {"HaHaHAhAhAhaHa eu só estava brincando, você quer me desafiar para uma batalha, certo?", "Eu aceito o desafio, mas durante o caminho deixa eu te falar sobre os benefícios de ser consulto...", " ", "As apresentações SEM interferência ganharão -1 de apelo."}};
